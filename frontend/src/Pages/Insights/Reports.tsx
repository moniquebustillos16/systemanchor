...
function Reports() {
  ...
  const canView = can(userPermissions, "reports.view", "analytics.view");
  const canCreate = can(userPermissions, "reports.create", "reports.export");
  const canUpdate = can(userPermissions, "reports.update", "reports.export");
